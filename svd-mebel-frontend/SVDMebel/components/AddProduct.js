...
const AddProduct = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                ...
                const response = await axios.get('http://192.168.230.67:5000/category');
        ...
        const fetchSubcategories = async (categoryId) => {
            if (categoryId) {
                try {
                    ...
                    const response = await axios.get(`http://192.168.230.67:5000/subcategory/${categoryId}/subcategories`);
        ...
        const fetchAttributes = async (subcategoryId) => {
            if (subcategoryId) {
                try {
                    ...
                    const response = await axios.get(`http://192.168.230.67:5000/products/attributes/subcategory/${subcategoryId}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.230.67:5000/products/add', formData, {
                headers: {
